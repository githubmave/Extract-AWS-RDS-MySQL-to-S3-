...
db_name = ssm.get_parameter(Name='/RDS/DH',WithDecryption=False)['Parameter']['Value']
...
logger.info("SUCCESS: Connection to RDS MySQL instance succeed.")
...
def handler(event,context):
    ...
    try:
        with conn.cursor() as cur:
            ...
            data.coloums = [desc[0] for desc in cur.description]
    ...
    def upload_file(bucket,key_name,local_file):
        ...
        logger.info(f"SUCCESS: Upload {local_file} to {bucket} as {key_name}")
